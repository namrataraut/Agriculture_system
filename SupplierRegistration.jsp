...
<div class="w3layouts-main">
	<h2>Supplier Registration Form</h2>
		<form action="SupplierRegistrationServlet" method="post" style="font-size: 15px">
		<div>

                <input type="hidden" id="user_id">
				<div class="form-group">
					<label> Name:</label>
					<input type="text" name="sname" class="form-control" id="user" required="required">
					<span id="user_error"></span>
				</div>
				
				<div class="form-group">
					<label> Email-Id:</label>
					<input type="email" name="semail" class="form-control" id="email" required="required">
					<span id="email-error"></span>
				</div>
				
				<div class="form-group">
					<label> Password:</label>
					<input type="password" name="spassword" class="form-control" id="email" required="required">
					<span id="email-error"></span>
				</div>
				
				<div class="form-group">
					<label> Address:</label>
					<input type="text" name="saddress" class="form-control" id="user" required="required">
					<span id="user_error"></span>
				</div>
				
				<div class="form-group">
					<label> Phone No:</label>
					<input type="number" name="sphone" class="form-control" id="pass" required="required">
					<span id="pass_error"></span>
				</div>
				
				<div class="form-group">
					<label> Company:</label>
					<input type="text" name="scompany" class="form-control" id="pass" required="required">
					<span id="pass_error"></span>
				</div>
				...
				<div class="button ">
			    <input type="submit" class="btn-btn-success btn-lg col-lg-offset-4"  value="Register" > 
			    <a href="index.html"></a>
			     <input type="submit" class="btn-btn-success btn-lg col-lg-offset-4"  value="Reset" > 
			    <a href="index.html"></a>
				</div>
				<div class="button ">
...
<td colspan="2"><b>Already registered!!</b> <a href="Supplier.jsp">Login Here</a></td>
</tr>	
		</div>
	</div>
			</form>
